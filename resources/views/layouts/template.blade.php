...
<body>
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-10 transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    ...
    <div class="p-0 md:ml-64">
        <div class="p-4">
            <div class="container mx-auto">
                <div>
                    <nav class="justify-between py-3 text-gray-700 md:flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center mb-3 space-x-1 md:space-x-3 md:mb-0">
                            <li>
                                <div>
